...
Some calculations were conducted using the DFT-B3LYP method, and 6-311G** basis for a couple of atoms and molecules are attached as examples. To execute information and complexity for the chemical systems, follow the given instructions. 
...
12) CPU.text
 ...
 The given code will generate the two following files as the final outputs   
 1) 'information.dat'  
 2) 'complexity.dat'     
 3) 'Moments.dat'
